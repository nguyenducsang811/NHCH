...
export const CURRICULUM_DATA: Record<string, CurriculumGrade> = {
 "6": { "code": "6",
  "D": [
   { "code": "1", "title": "CHƯƠNG I. TẬP HỢP CÁC SỐ TỰ NHIÊN", "lessons": [
    { "code": "1", "title": "Bài 1. Tập hợp", "types": [
     { "code": "1", "title": "Nhận biết phần tử thuộc hoặc không thuộc tập hợp" },
     { "code": "2", "title": "Viết tập hợp bằng cách liệt kê các phần tử" },
     { "code": "3", "title": "Viết tập hợp bằng cách chỉ ra tính chất đặc trưng" },
     { "code": "4", "title": "Xác định số phần tử của tập hợp hữu hạn" },
     { "code": "5", "title": "Mô tả một tập hợp từ dữ kiện cho trước" },
     { "code": "6", "title": "Minh họa tập hợp bằng biểu đồ Ven" }
    ]},
    ...
    { "code": "3", "title": "Bài 3. Thứ tự trong tập hợp các số tự nhiên", "types": [
     { "code": "1", "title": "So sánh hai số tự nhiên" },
     { "code": "2", "title": "Tìm số liền trước, số liền sau của một số tự nhiên" },
     { "code": "3", "title": "Biểu diễn số tự nhiên trên tia số" },
     { "code": "4", "title": "Sắp xếp các số tự nhiên theo thứ tự tăng dần hoặc giảm dần" },
     { "code": "5", "title": "Tìm số tự nhiên thỏa mãn điều kiện về thứ tự" },
     { "code": "6", "title": "Biểu diễn tập hợp các số tự nhiên thỏa mãn điều kiện cho trước" },
     { "code": "7", "title": "Tìm quy luật của dãy số tự nhiên" },
     { "code": "8", "title": "Đếm số hoặc chữ số thỏa mãn điều kiện" }
    ]},
    ...
    { "code": "6", "title": "Bài 6. Luỹ thừa với số mũ tự nhiên", "types": [
     ...
     { "code": "10", "title": "Bài tập liên quan đến a bình phương, a lập phương" },
   ...
   { "code": "2", "title": "CHƯƠNG II. TÍNH CHIA HẾT TRONG TẬP HỢP CÁC SỐ TỰ NHIÊN", "lessons": [
   ...
   { "code": "3", "title": "CHƯƠNG III. SỐ NGUYÊN", "lessons": [
   ...
   { "code": "6", "title": "CHƯƠNG VI. PHÂN SỐ", "lessons": [
    ...
    { "code": "27", "title": "Bài 27. Hai bài toán về phân số", "types": [
     ...
     { "code": "3", "title": "Giải bài toán tổng hợp về hai bài toán cơ bản của phân số" }
    ]}
   ]},
   { "code": "7", "title": "CHƯƠNG VII. SỐ THẬP PHÂN", "lessons": [
  ...
  "H": [
   { "code": "4", "title": "CHƯƠNG IV. MỘT SỐ HÌNH PHẲNG TRONG THỰC TIỄN", "lessons": [
   ...
   { "code": "5", "title": "CHƯƠNG V. TÍNH ĐỐI XỨNG CỦA HÌNH PHẲNG TRONG TỰ NHIÊN", "lessons": [
    ...
    { "code": "22", "title": "Bài 22. Hình có tâm đối xứng", "types": [
     ...
     { "code": "2", "title": "Xác định tâm đối xứng của hình" },
     { "code": "3", "title": "Hoàn thiện hình vẽ dựa vào tâm đối xứng" }
    ]}
   ]},
   { "code": "8", "title": "CHƯƠNG VIII. NHỮNG HÌNH HỌC CƠ BẢN", "lessons": [
    { "code": "32", "title": "Bài 32. Điểm và đường thẳng", "types": [
     { "code": "1", "title": "Nhận biết điểm thuộc và không thuộc đường thẳng" },
     { "code": "2", "title": "Vẽ đường thẳng đi qua một hoặc hai điểm" },
     { "code": "3", "title": "Nhận biết ba điểm thẳng hàng" },
     { "code": "4", "title": "Đếm số đường thẳng xác định bởi các cặp điểm" },
     { "code": "5", "title": "Nhận biết hai đường thẳng cắt nhau, song song hoặc trùng nhau" }
    ]},
    { "code": "33", "title": "Bài 33. Điểm nằm giữa hai điểm. Tia", "types": [
     { "code": "1", "title": "Nhận biết điểm nằm giữa hai điểm" },
     { "code": "2", "title": "Nhận biết tia và gốc của tia" },
     { "code": "3", "title": "Nhận biết hai tia đối nhau hoặc hai tia trùng nhau" },
     { "code": "4", "title": "Vận dụng quan hệ điểm nằm giữa trên một tia" }
    ]},
  ...
  "X": [
   { "code": "9", "title": "CHƯƠNG IX. DỮ LIỆU VÀ XÁC SUẤT THỰC NGHIỆM", "lessons": [
 ...
 "7": { "code": "7",
  "D": [
   { "code": "1", "title": "Chương I. SỐ HỮU TỈ", "lessons": [
   ...
   { "code": "2", "title": "Chương II. SỐ THỰC", "lessons": [
    { "code": "5", "title": "Bài 5. Làm quen với số thập phân vô hạn tuần hoàn", "types": [
     { "code": "1", "title": "Nhận biết số thập phân hữu hạn và số thập phân vô hạn tuần hoàn" },
    ...
    { "code": "6", "title": "Bài 6. Số vô tỉ. Căn bậc hai số học", "types": [
     { "code": "1", "title": "Nhận biết số vô tỉ và số thập phân vô hạn không tuần hoàn" },
     { "code": "2", "title": "Tính căn bậc hai số học của một số không âm" },
     { "code": "3", "title": "Tìm số biết bình phương hoặc căn bậc hai số học của nó" },
     { "code": "4", "title": "So sánh các căn bậc hai số học" },
     { "code": "5", "title": "Tính giá trị biểu thức chứa căn bậc hai số học" }
    ]},
   ...
   { "code": "6", "title": "Chương VI. TỈ LỆ THỨC VÀ ĐẠI LƯỢNG TỈ LỆ", "lessons": [
   ...
   { "code": "7", "title": "Chương VII. BIỂU THỨC ĐẠI SỐ VÀ ĐA THỨC MỘT BIẾN", "lessons": [
  ...
  "H": [
   { "code": "3", "title": "Chương III. GÓC VÀ ĐƯỜNG THẲNG SONG SONG", "lessons": [
   ...
   { "code": "4", "title": "Chương IV. TAM GIÁC BẰNG NHAU", "lessons": [
    { "code": "12", "title": "Bài 12. Tổng các góc trong một tam giác", "types": [
     { "code": "1", "title": "Tính số đo góc trong tam giác khi biết hai góc còn lại" },
     { "code": "2", "title": "Tính góc ngoài của tam giác" },
     { "code": "3", "title": "Tính góc trong tam giác vuông bằng tổng ba góc" },
    ...
    { "code": "16", "title": "Bài 16. Tam giác cân. Đường trung trực của đoạn thẳng", "types": [
     { "code": "1", "title": "Nhận biết tam giác cân, tam giác đều" },
     { "code": "2", "title": "Tính số đo góc trong tam giác cân hoặc tam giác đều" },
     { "code": "3", "title": "Chứng minh tam giác cân hoặc tam giác đều" },
     { "code": "4", "title": "Nhận biết và chứng minh một đường thẳng là đường trung trực của đoạn thẳng" },
     { "code": "5", "title": "Chứng minh điểm nằm trên đường trung trực" },
     { "code": "6", "title": "Vận dụng tính chất đường trung trực trong bài toán hình học" }
    ]}
   ]},
   { "code": "9", "title": "Chương IX. QUAN HỆ GIỮA CÁC YẾU TỐ TRONG MỘT TAM GIÁC", "lessons": [
   ...
   { "code": "10", "title": "Chương X. MỘT SỐ HÌNH KHỐI TRONG THỰC TIỄN", "lessons": [
  ...
  "X": [
   { "code": "5", "title": "Chương V. THU THẬP VÀ BIỂU DIỄN DỮ LIỆU", "lessons": [
   ...
   { "code": "8", "title": "Chương VIII. LÀM QUEN VỚI BIẾN CỐ VÀ XÁC SUẤT CỦA BIẾN CỐ", "lessons": [
 ...
 "8": { "code": "8",
  "D": [
   { "code": "1", "title": "Chương I. ĐA THỨC", "lessons": [
   ...
   { "code": "2", "title": "Chương II. HẰNG ĐẲNG THỨC ĐÁNG NHỚ VÀ ỨNG DỤNG", "lessons": [
    ...
    { "code": "8", "title": "Bài 8. Tổng và hiệu hai lập phương", "types": [
    ...
    { "code": "9", "title": "Bài 9. Phân tích đa thức thành nhân tử", "types": [
     { "code": "1", "title": "Phân tích đa thức thành nhân tử bằng phương pháp đặt nhân tử chung" },
     { "code": "2", "title": "Phân tích đa thức thành nhân tử bằng hằng đẳng thức" },
     { "code": "3", "title": "Phân tích đa thức thành nhân tử bằng phương pháp nhóm hạng tử" },
     { "code": "4", "title": "Phân tích đa thức thành nhân tử bằng cách phối hợp nhiều phương pháp" },
     { "code": "5", "title": "Phân tích đa thức thành nhân tử bằng cách tách, thêm bớt hạng tử" }
    ]}
   ]},
   { "code": "6", "title": "Chương VI. PHÂN THỨC ĐẠI SỐ", "lessons": [
    { "code": "21", "title": "Bài 21. Phân thức đại số", "types": [
   ...
   { "code": "7", "title": "Chương VII. PHƯƠNG TRÌNH BẬC NHẤT VÀ HÀM SỐ BẬC NHẤT", "lessons": [
    { "code": "25", "title": "Bài 25. Phương trình bậc nhất một ẩn", "types": [
     { "code": "1", "title": "Nhận biết phương trình bậc nhất một ẩn" },
     { "code": "2", "title": "Giải phương trình bậc nhất dạng ax+b=0" },
     { "code": "3", "title": "Giải phương trình đưa về dạng bậc nhất một ẩn" },
     { "code": "4", "title": "Giải phương trình đưa về dạng tích bằng phân tích đa thức thành nhân tử" },
     { "code": "5", "title": "Biện luận phương trình bậc nhất theo tham số" }
    ]},
    ...
    { "code": "27", "title": "Bài 27. Khái niệm hàm số và đồ thị của hàm số", "types": [
  ...
  "H": [
   { "code": "3", "title": "Chương III. TỨ GIÁC", "lessons": [
   ...
   { "code": "4", "title": "CHƯƠNG IV. ĐỊNH LÍ THALES", "lessons": [
   ...
   { "code": "9", "title": "Chương IX. TAM GIÁC ĐỒNG DẠNG", "lessons": [
  ...
  "X": [
   { "code": "5", "title": "Chương V. DỮ LIỆU VÀ BIỂU ĐỒ", "lessons": [
    ...
    { "code": "20", "title": "Bài 20. Phân tích số liệu thống kê dựa vào biểu đồ", "types": [
   ...
   { "code": "8", "title": "Chương VIII. MỞ ĐẦU VỀ TÍNH XÁC SUẤT CỦA BIẾN CỐ", "lessons": [
 ...
 "9": { "code": "9",
  "D": [
   { "code": "1", "title": "Chương I. PHƯƠNG TRÌNH VÀ HỆ HAI PHƯƠNG TRÌNH BẬC NHẤT HAI ẨN", "lessons": [
   ...
   { "code": "2", "title": "Chương II. PHƯƠNG TRÌNH VÀ BẤT PHƯƠNG TRÌNH BẬC NHẤT MỘT ẨN", "lessons": [
    ...
    { "code": "5", "title": "Bài 5. Bất đẳng thức và tính chất", "types": [
     { "code": "1", "title": "Nhận biết và viết bất đẳng thức" },
     { "code": "2", "title": "So sánh hai số bằng định nghĩa bất đẳng thức" },
     { "code": "3", "title": "Vận dụng tính chất liên hệ giữa thứ tự và phép cộng" },
     { "code": "4", "title": "Vận dụng tính chất liên hệ giữa thứ tự và phép nhân" },
     { "code": "5", "title": "Biến đổi và chứng minh bất đẳng thức bằng các tính chất đã học" },
     { "code": "6", "title": "Giải bài toán thực tế liên quan đến bất đẳng thức" }
    ]},
   ...
   { "code": "3", "title": "Chương III. CĂN BẬC HAI VÀ CĂN BẬC BA", "lessons": [
   ...
   { "code": "6", "title": "Chương VI. HÀM SỐ y = ax2. PHƯƠNG TRÌNH BẬC HAI MỘT ẨN", "lessons": [
    { "code": "18", "title": "Bài 18. Hàm số y = ax^2 (a ≠ 0)", "types": [
     { "code": "1", "title": "Tính giá trị của hàm số y=ax^2" },
     { "code": "2", "title": "Lập bảng giá trị của hàm số y=ax^2" },
     { "code": "3", "title": "Nhận biết tính đồng biến, nghịch biến của hàm số y=ax^2" },
     { "code": "4", "title": "Vẽ đồ thị parabol y=ax^2" },
     { "code": "5", "title": "Kiểm tra điểm thuộc đồ thị y=ax^2" },
     { "code": "6", "title": "Xác định hệ số a khi biết đồ thị đi qua một điểm" }
    ]},
    { "code": "19", "title": "Bài 19. Phương trình bậc hai một ẩn", "types": [
     { "code": "1", "title": "Giải phương trình bậc hai khuyết" },
     { "code": "2", "title": "Giải phương trình bậc hai bằng công thức nghiệm" },
     { "code": "3", "title": "Giải phương trình bậc hai bằng công thức nghiệm thu gọn" },
     { "code": "4", "title": "Biện luận số nghiệm của phương trình bậc hai theo tham số" },
     { "code": "5", "title": "Tìm giao điểm của parabol và đường thẳng bằng phương trình bậc hai" },
     { "code": "6", "title": "Tìm tham số để parabol và đường thẳng cắt nhau, tiếp xúc hoặc không giao nhau" }
    ]},
  ...
  "H": [
   { "code": "4", "title": "Chương IV. HỆ THỨC LƯỢNG TRONG TAM GIÁC VUÔNG", "lessons": [
    ...
    { "code": "12", "title": "Bài 12. Một số hệ thức giữa cạnh, góc trong tam giác vuông và ứng dụng", "types": [
     { "code": "1", "title": "Tính cạnh góc vuông bằng cạnh huyền và sin hoặc cos của góc nhọn" },
     { "code": "2", "title": "Tính cạnh góc vuông bằng cạnh góc vuông còn lại và tan hoặc cot của góc nhọn" },
     { "code": "3", "title": "Tính góc nhọn từ các tỉ số lượng giác trong tam giác vuông" },
     { "code": "4", "title": "Giải tam giác vuông" },
     { "code": "5", "title": "Vận dụng hệ thức giữa cạnh và góc để đo chiều cao, khoảng cách" },
     { "code": "6", "title": "Phối hợp định lí Pythagore và các tỉ số lượng giác trong tam giác vuông" }
    ]}
   ]},
   { "code": "5", "title": "Chương V. ĐƯỜNG TRÒN", "lessons": [
   ...
   { "code": "9", "title": "Chương IX. ĐƯỜNG TRÒN NGOẠI TIẾP VÀ ĐƯỜNG TRÒN NỘI TIẾP", "lessons": [
  ...
  "X": [
   { "code": "7", "title": "Chương VII. TẦN SỐ VÀ TẦN SỐ TƯƠNG ĐỐI", "lessons": [
   ...
   { "code": "8", "title": "Chương VIII. XÁC SUẤT CỦA BIẾN CỐ TRONG MỘT SỐ MÔ HÌNH XÁC SUẤT ĐƠN GIẢN", "lessons": [
    ...
    { "code": "26", "title": "Bài 26. Xác suất của biến cố liên quan tới phép thử", "types": [
     { "code": "1", "title": "Xác định số kết quả có thể và số kết quả thuận lợi của phép thử đơn giản" },
     { "code": "2", "title": "Tính xác suất của biến cố trong mô hình đồng khả năng" },
     { "code": "3", "title": "Tính xác suất trong phép thử gieo đồng xu, xúc xắc, rút thẻ hoặc chọn vật đơn giản" },
     { "code": "4", "title": "Liệt kê kết quả bằng bảng, sơ đồ cây hoặc danh sách để tính xác suất" },
     { "code": "5", "title": "Giải bài toán thực tế bằng mô hình xác suất đơn giản" }
    ]}
   ]}
  ]
 },
 "10": { "code": "0",
  "D": [
   { "code": "1", "title": "CHƯƠNG I. MỆNH ĐỀ VÀ TẬP HỢP", "lessons": [
   ...
   { "code": "2", "title": "CHƯƠNG II. BẤT PHƯƠNG TRÌNH VÀ HỆ BẤT PHƯƠNG TRÌNH BẬC NHẤT HAI ẨN", "lessons": [
   ...
   { "code": "6", "title": "CHƯƠNG VI. HÀM SỐ, ĐỒ THỊ VÀ ỨNG DỤNG", "lessons": [
   ...
   { "code": "8", "title": "CHƯƠNG VIII. ĐẠI SỐ TỔ HỢP", "lessons": [
  ...
  "H": [
   { "code": "3", "title": "CHƯƠNG III. HỆ THỨC LƯỢNG TRONG TAM GIÁC", "lessons": [
   ...
   { "code": "4", "title": "CHƯƠNG IV. VECTƠ", "lessons": [
   ...
   { "code": "7", "title": "CHƯƠNG VII. PHƯƠNG PHÁP TOẠ ĐỘ TRONG MẶT PHẲNG", "lessons": [
    { "code": "19", "title": "Bài 19. Phương trình đường thẳng", "types": [
     { "code": "1", "title": "Nhận biết vectơ chỉ phương và vectơ pháp tuyến của đường thẳng" },
     { "code": "2", "title": "Viết phương trình tham số của đường thẳng" },
     { "code": "3", "title": "Viết phương trình tổng quát của đường thẳng" },
     { "code": "4", "title": "Chuyển đổi giữa phương trình tham số và phương trình tổng quát" },
     { "code": "5", "title": "Viết phương trình đường thẳng qua điểm và thỏa mãn điều kiện về phương" },
     { "code": "6", "title": "Viết phương trình các cạnh, đường cao, trung tuyến của tam giác" },
     { "code": "7", "title": "Viết phương trình đường thẳng theo dạng đoạn chắn" }
    ]},
    { "code": "20", "title": "Bài 20. Vị trí tương đối giữa hai đường thẳng. Góc và khoảng cách", "types": [
     { "code": "1", "title": "Xét vị trí tương đối của hai đường thẳng" },
     { "code": "2", "title": "Tìm giao điểm của hai đường thẳng" },
     { "code": "3", "title": "Tính góc giữa hai đường thẳng" },
     { "code": "4", "title": "Tính khoảng cách từ một điểm đến đường thẳng" },
     { "code": "5", "title": "Viết phương trình các đường phân giác của góc tạo bởi hai đường thẳng" },
     { "code": "6", "title": "Tìm hình chiếu vuông góc hoặc điểm đối xứng qua đường thẳng" },
     { "code": "7", "title": "Tìm điểm trên đường thẳng thỏa mãn điều kiện về góc hoặc khoảng cách" }
    ]},
  ...
  "X": [
   { "code": "5", "title": "CHƯƠNG V. CÁC SỐ ĐẶC TRƯNG CỦA MẪU SỐ LIỆU KHÔNG GHÉP NHÓM", "lessons": [
   ...
   { "code": "9", "title": "CHƯƠNG IX. TÍNH XÁC SUẤT THEO ĐỊNH NGHĨA CỔ ĐIỂN", "lessons": [
 ...
 "11": { "code": "1",
  "D": [
   { "code": "1", "title": "CHƯƠNG I. HÀM SỐ LƯỢNG GIÁC VÀ PHƯƠNG TRÌNH LƯỢNG GIÁC", "lessons": [
   ...
   { "code": "2", "title": "CHƯƠNG II. DÃY SỐ. CẤP SỐ CỘNG VÀ CẤP SỐ NHÂN", "lessons": [
   ...
   { "code": "5", "title": "CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC", "lessons": [
   ...
   { "code": "6", "title": "CHƯƠNG VI. HÀM SỐ MŨ VÀ HÀM SỐ LÔGARIT", "lessons": [
    ...
    { "code": "20", "title": "Bài 20. Hàm số mũ và hàm số lôgarit", "types": [
     { "code": "1", "title": "Tìm tập xác định của hàm số mũ và hàm số lôgarit" },
     { "code": "2", "title": "Xét tính đơn điệu của hàm số mũ và hàm số lôgarit" },
     { "code": "3", "title": "Vẽ và nhận biết đồ thị của hàm số mũ, hàm số lôgarit" },
     { "code": "4", "title": "Thực hiện phép biến đổi đồ thị đơn giản của hàm số mũ, hàm số lôgarit" },
     { "code": "5", "title": "Giải bài toán tăng trưởng, lãi suất bằng hàm số mũ" }
    ]},
   ...
   { "code": "9", "title": "CHƯƠNG IX. ĐẠO HÀM", "lessons": [
  ...
  "H": [
   { "code": "4", "title": "CHƯƠNG IV. QUAN HỆ SONG SONG TRONG KHÔNG GIAN", "lessons": [
    ...
    { "code": "11", "title": "Bài 11. Hai đường thẳng song song", "types": [
     { "code": "1", "title": "Nhận biết vị trí tương đối của hai đường thẳng trong không gian" },
     { "code": "2", "title": "Chứng minh hai đường thẳng song song" },
     { "code": "3", "title": "Vận dụng tính chất của hai đường thẳng song song trong hình không gian" }
    ]},
   ...
   { "code": "7", "title": "CHƯƠNG VII. QUAN HỆ VUÔNG GÓC TRONG KHÔNG GIAN", "lessons": [
    { "code": "22", "title": "Bài 22. Hai đường thẳng vuông góc", "types": [
     { "code": "1", "title": "Tính góc giữa hai vectơ trong không gian" },
     { "code": "2", "title": "Tính góc giữa hai đường thẳng trong không gian, kể cả hai đường thẳng chéo nhau" },
     { "code": "3", "title": "Chứng minh hai đường thẳng vuông góc" },
     { "code": "4", "title": "Vận dụng tích vô hướng để xác định góc hoặc quan hệ vuông góc" }
    ]},
  ...
  "X": [
   { "code": "3", "title": "CHƯƠNG III. CÁC SỐ ĐẶC TRƯNG ĐO XU THẾ TRUNG TÂM CỦA MẪU SỐ LIỆU GHÉP NHÓM", "lessons": [
    { "code": "8", "title": "Bài 8. Mẫu số liệu ghép nhóm", "types": [
     { "code": "1", "title": "Chuyển dữ liệu không ghép nhóm sang ghép nhóm" },
     { "code": "2", "title": "Xác định giá trị đại diện của nhóm" },
     { "code": "3", "title": "Đọc và giải thích mẫu số liệu" }
    ]},
    { "code": "9", "title": "Bài 9. Các số đặc trưng đo xu thế trung tâm", "types": [
     { "code": "1", "title": "Tính số trung bình của mẫu ghép nhóm" },
     { "code": "2", "title": "Tính trung vị (Median) của mẫu ghép nhóm" },
     { "code": "3", "title": "Tính tứ phân vị của mẫu ghép nhóm" },
     { "code": "4", "title": "Tính mốt (Mode) của mẫu ghép nhóm" },
     { "code": "5", "title": "Ý nghĩa của các số đặc trưng đo xu thế trung tâm ghép nhóm" }
    ]}
   ]},
   { "code": "8", "title": "CHƯƠNG VIII. CÁC QUY TẮC TÍNH XÁC SUẤT", "lessons": [
    { "code": "28", "title": "Bài 28. Biến cố hợp, biến cố giao, biến cố độc lập", "types": [
     { "code": "1", "title": "Mô tả biến cố hợp, biến cố giao" },
     { "code": "2", "title": "Kiểm tra hai biến cố độc lập" }
    ]},
    { "code": "29", "title": "Bài 29. Công thức cộng xác suất", "types": [
     { "code": "1", "title": "Tính xác suất biến cố hợp (biến cố xung khắc)" },
     { "code": "2", "title": "Tính xác suất biến cố hợp (công thức cộng tổng quát)" }
    ]},
    { "code": "30", "title": "Bài 30. Công thức nhân xác suất cho hai biến cố độc lập", "types": [
     { "code": "1", "title": "Tính xác suất biến cố giao của hai biến cố độc lập" },
     { "code": "2", "title": "Sử dụng sơ đồ hình cây để giải toán xác suất nhiều giai đoạn" },
     { "code": "3", "title": "Bài toán xác suất bắn bia, mạch điện" },
     { "code": "4", "title": "Bài toán thực tế vận dụng công thức nhân xác suất" }
    ]}
   ]}
  ]
 },
 "12": { "code": "2",
  "D": [
   { "code": "1", "title": "CHƯƠNG I. ỨNG DỤNG ĐẠO HÀM ĐỂ KHẢO SÁT VÀ VẼ ĐỒ THỊ HÀM SỐ", "lessons": [
   ...
   { "code": "4", "title": "CHƯƠNG IV. NGUYÊN HÀM VÀ TÍCH PHÂN", "lessons": [
  ...
  "H": [
   { "code": "2", "title": "CHƯƠNG II. VECTƠ VÀ HỆ TRỤC TOẠ ĐỘ TRONG KHÔNG GIAN", "lessons": [
    ...
    { "code": "7", "title": "Bài 7. Hệ trục toạ độ trong không gian", "types": [
     { "code": "1", "title": "Nhận biết hệ trục tọa độ Oxyz, các trục và các mặt phẳng tọa độ" },
     { "code": "2", "title": "Xác định tọa độ của điểm trong không gian" },
     { "code": "3", "title": "Xác định tọa độ của vectơ theo các vectơ đơn vị" },
     { "code": "4", "title": "Nhận biết vị trí của điểm thuộc trục hoặc mặt phẳng tọa độ" }
    ]},
    { "code": "8", "title": "Bài 8. Biểu thức toạ độ của các phép toán vectơ", "types": [
     { "code": "1", "title": "Tính tọa độ tổng, hiệu và tích của vectơ với một số" },
     { "code": "2", "title": "Tính tọa độ vectơ nối hai điểm" },
     { "code": "3", "title": "Tìm tọa độ trung điểm của đoạn thẳng và trọng tâm tam giác" },
     { "code": "4", "title": "Tính tích vô hướng của hai vectơ bằng tọa độ" },
     { "code": "5", "title": "Tính độ dài vectơ, khoảng cách giữa hai điểm và góc giữa hai vectơ" },
     { "code": "6", "title": "Chứng minh hai vectơ vuông góc, cùng phương hoặc ba điểm thẳng hàng bằng tọa độ" },
     { "code": "7", "title": "Tìm điểm thỏa mãn đẳng thức vectơ" },
     { "code": "8", "title": "Vận dụng biểu thức tọa độ của vectơ vào bài toán thực tế" }
    ]}
   ]},
   { "code": "5", "title": "CHƯƠNG V. PHƯƠNG PHÁP TOẠ ĐỘ TRONG KHÔNG GIAN", "lessons": [
  ...
  "X": [
   { "code": "3", "title": "CHƯƠNG III. CÁC SỐ ĐẶC TRƯNG ĐO MỨC ĐỘ PHÂN TÁN CỦA MẪU SỐ LIỆU GHÉP NHÓM", "lessons": [
   ...
   { "code": "6", "title": "CHƯƠNG VI. XÁC SUẤT CÓ ĐIỀU KIỆN", "lessons": [
